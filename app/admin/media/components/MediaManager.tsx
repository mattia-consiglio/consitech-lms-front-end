...
export default function MediaManager({
	...
	const [media, setMedia] = useState<PageableContent<Media>>(
		{} as PageableContent<Media>,
	)
				...
				<div className="flex gap-4 mb-4">
					...
					>
						<span className="flex justify-center items-center gap-2">
							{!displayTitle && <span>Aggiorna</span>}{" "}
							<FaRotate title="Aggiorna" />
						</span>
					</Button>
				</div>
					...
					{selected && (
						<>
							...
							{selected.type === "VIDEO" && (
								<>
									<p>
										Durata: {formatTime((selected as MediaVideo)?.duration)}
									</p>
									<p>
										Risoluzioni:{" "}

...
export default function AdminContentBlock({
	content,
	type,
}: Readonly<AdminContentBlockProps>) {
	...
	return (
		<div
			className={
				"border-3 border-transparent hover:border-neutral-300 hover:bg-neutral-100 dark:hover:border-neutral-700 dark:hover:bg-neutral-800 p-4 transition-colors duration-250 ease-in-out relative group"
			}
		>
			<div
				className={
					"grid grid-cols-1 md:grid-cols-[100px_1fr_auto] items-center"
				}
			>
				{!thumbnailImage ? (
